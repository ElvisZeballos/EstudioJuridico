  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-900 to-slate-900">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-blue-500 rounded-full opacity-10 blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      </div>

      {/* Theme toggle */}
      <button
        onClick={toggleTheme}
        className="absolute top-6 right-6 p-2.5 rounded-xl bg-white/10 backdrop-blur-md text-white hover:bg-white/20 transition-all duration-200 border border-white/20"
      ...
      <div className="relative w-full max-w-md mx-4 animate-slide-up">
        <div className="bg-white/10 backdrop-blur-md rounded-3xl shadow-2xl border border-white/20 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-white">Estudio Jurídico Martínez</h1>
            <p className="text-white/60 text-sm mt-1">Sistema de Gestión Legal</p>
          </div>
        ...
        <p className="text-center text-white/30 text-xs mt-6">
          © {new Date().getFullYear()} Estudio Jurídico Martínez. Todos los derechos reservados.
        </p>
      </div>
    </div>
  );
